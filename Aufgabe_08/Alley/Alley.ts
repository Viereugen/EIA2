namespace L08_Canvas_Alley {
    ...
    function handleLoad(_event: Event): void {
        ...
        let posStreet: Vector = { x: crc2.canvas.width / 1.5, y: horizon };
        ...
        drawMountains(posMountains, 75, 200, "darkgreen", "white");
        drawGHB({ x: 120, y: horizon });
        drawMountains(posMountains, 50, 100, "darkgreen", "white");
    ...
    function drawGHB(_position: Vector): void{
        crc2.save();
        crc2.translate(_position.x, _position.y);
        crc2.fillStyle = "grey";
        crc2.fillRect(0, 0, 50, -170);
        crc2.fillRect(70, 0, 50, -150);
        crc2.restore();
    }
    ...
    //         let colorAngle: number = 90 - Math.random() * 60;
